"""
Find and remove duplicate files in a given directory
...
def get_hash(filename, first_chunk_only=False, hash=hashlib.sha1):
    """Calculate the hash of a file using SHA-1 algorithm"""
    hashobj = hash()
...
def check_for_duplicates(paths, hash=hashlib.sha1):
    """Check duplicates by size then by file hash"""
...
# TODO: group duplicates together and enable deletion
